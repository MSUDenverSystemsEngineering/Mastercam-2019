...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close Mastercam if needed, verify there is enough disk space to complete the install, and persist the prompt
		...
		If (Test-Path -Path "${envProgramFiles}\Mcam2018\mastercam.exe" -PathType 'Leaf') {
			#Uninstall Mastercam 2018
			Execute-MSI -Action "Uninstall" -Path "{B66E2B7B-6BD8-49BD-815C-48BF88D24406}" -PassThru
			#Uninstall Licensing Tools
			Execute-MSI -Action "Uninstall" -Path "{B24C5998-F0BC-44B9-816D-FD9FCB73290A}" -PassThru
			#Uninstall CodeMeter Tools
			Execute-MSI -Action "Uninstall" -Path "{8BA3DC19-F968-41C4-826C-6202FA4B653C}" -PassThru
		}
		...
		# Old lines used for installing updates. Keeping for reference
		...
		Remove-File -Path "C:\Users\Public\Desktop\Mastercam 2019.lnk"
		Copy-File -Path "$dirFiles\nethasp.ini" -Destination "C:\Program Files\Mcam2019\nethasp.ini"

		[scriptblock]$HKCURegistrySettings = {
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2019\Configurations\Dialog data\UpdateNotify" -Name "AutoCheck" -Value "0" -Type "DWord" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2019\Customer Feedback Program" -Name "Enabled" -Value "0" -Type "DWord" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2019\Customer Feedback Program" -Name "Reminder" -Value "7:17:2020:18:12:38" -Type "String" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2019" -Name "EULA count" -Value "2" -Type "DWord" -SID $UserProfile.SID
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close Mastercam with a 60 second countdown before automatically closing
		...
		# Uninstall CodeMeter Licensing Software
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD22ZXO7b1e/Nj7
# J/sbtxXWnOjyI51IsgOVIQjumWtWFqCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgxCq8M+6m
# s/GksCspV6tv68bEBeArXr4XJkLpX6d5upwwDQYJKoZIhvcNAQEBBQAEggEAd9pg
# UZIyVzbnjZG/LmHMg/xeX45fRri3kehJG7nYZV/RyU7K2ppV+0JDwyGx9Xhy620r
# AL/QHh3/xKaDEpBwXNFuRwsn2btnB/W0WENl681kt66qTXfRU/9sK9ZBFFml1r9r
# mcZt1yLsstl0NiIhi7jNgd3t1rIpbxeT2NWz4bQPGo/XnJs2XoRbqZaBM+SsyaCU
# 2uE7zXKTTrblKlxanfbY4xQZk58jh8593Dfbvlod7ll5FdYSJR1nCoCkNz8v9TWw
# x+XUVVpkzvJty81bkHcMMsaFSPw6Ms4D/81+GqgC8pwf5qZ3YdDlTcr+ZFV3+HL7
# c6qzUtjyq6FOT3xFxaGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA3MTkyMDI0NDVaMCMGCSqGSIb3DQEJBDEWBBRKIzut
# wDRJu8w+t0KmNyhIoR03gDCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAkp5N9VsgHQXPPYoQNgMwJOJTXl32okliTv39M6LZe5/O5z54pTOkhitf7hOP
# bMf8BHWh0iQJULux/90+4M3mJdZX2WpbFWhyWKE5JsZZL+GWcaQnAyJEN9uInBgb
# D4JkGaEXkhfM8IIqm/o8rvAEKKI13/7hfAh3dt8+DeE43CKfPI5W8eSBU9IzXqzx
# qlx8ZmkP6ni9CLh+9kAy2CVoHv/lMpYoFOKQTxWWqvL2KUmZzHCK4WRMg1nd0506
# wqmx1Vpq3URLIRlP2yniNnwFs8qCI4ECm2RaJzqdIhrW5029j/PFB1y78RMPnE+R
# lKPCCICSV1sT7tdBL1CyuZFN6w==
